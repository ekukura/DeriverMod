...
import theDeriver.patches.relics.BottledPlaceholderField;
import theDeriver.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theDeriver.DefaultMod.makeRelicOutlinePath;
import static theDeriver.DefaultMod.makeRelicPath;
